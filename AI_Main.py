...
def greetMe():
    ...
    if currentH >= 18 and currentH !=0:
        ...
        toaster.show_toast((greetMe()) , duration=4)
...
if __name__ == '__main__':
    ...
    if n <= 1:
        ...
        if 'open youtube' in query:
            ...
            webbrowser.open('https://www.opera.com/hi')
            print('''
            -------------------------------------------------------------------------------------------------------
            WARNING!
           ...
           """
            ...
            if 'me' in recipient or 'MI' in recipient or "mi" in recipient:
                try:
                    ...
                    server.ehlo()
                    server.starttls()
                    server.login("arduinobot.vbps@gmail.com", 'arduinobot@123')
                    server.sendmail('arduinobot.vbps@gmail.com', "arduinobot.vbps@gamil.com", content)
                    server.close()
                    speak('Email sent!')
        ...
        elif "start face recognition" in query or "face recognition" in query:
